(() => {
  ...
  // src/inspectors/ConfluenceSearch.ts
  var ConfluenceSearchActionPropertyInspector = class extends PollingActionInspector {
    constructor() {
      super(...arguments);
      this.cql = document.getElementById("cql");
  ...
  __name(ConfluenceSearchActionPropertyInspector, "ConfluenceSearchActionPropertyInspector");
  var inspector = new ConfluenceSearchActionPropertyInspector({ plugin: plugin_default });
  inspector.run();
})();
