(() => {
  ...
  // src/inspectors/Query.ts
  var QueryActionPropertyInspector = class extends PollingActionInspector {
    constructor() {
      super(...arguments);
      this.authentication = document.getElementById("auth");
      this.icon = document.getElementById("icon");
      this.jql = document.getElementById("jql");
      this.keyAction = document.getElementById("key-action");
      this.keyActionLimit = document.getElementById("key-action-limit");
      this.keyActionUrl = document.getElementById("key-action-url");
    }
    /**
     * {@inheritDoc}
     */
    updateForm() {
      ...
      if (typeof settings.keyAction === "string") {
        ...
        this.keyActionLimit.value = `${(_a = settings.keyAction.limit) != null ? _a : 5}`;
  ...
  __name(QueryActionPropertyInspector, "QueryActionPropertyInspector");
  var inspector = new QueryActionPropertyInspector({ plugin: plugin_default });
  inspector.run();
})();
